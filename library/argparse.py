...
class ArgumentsParser():
    ...
    def add_argument(self, cmdregex, flow):
...
class VArgumentsParser(object):
    ...
    def add_argument(self, shorten_cmd: str, long_cmd: str, option: str, execute: str):
    ...
    def add_argument_with_subaction(self, base_shorten_cmd: str,
                                    base_long_cmd: str, action: str, option: str, execute: str):
